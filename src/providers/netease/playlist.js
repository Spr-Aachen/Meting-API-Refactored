...
export const get_playlist = async (id, cookie = '') => {
    ...
    let res = await request('POST', `https://music.163.com/api/v6/playlist/detail`, data, { crypto: 'api', cookie: cookie ? cookie : undefined })
    ...
    res = await request(
        ...
        idsData,
        { crypto: 'weapi', cookie: cookie ? cookie : undefined }
    )
